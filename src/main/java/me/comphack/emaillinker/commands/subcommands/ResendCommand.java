...
public class ResendCommand extends SubCommand {
    ...
    public String getSyntax() {
        return "/email resend <EmailAddress>";
    }
    ...
    public void perform(Player player, String[] args) throws SQLException {
        ...
        if(player.hasPermission("emaillinker.command.resend") || player.hasPermission("emaillinker.command.*")) {
            if (args.length <= 1) {
